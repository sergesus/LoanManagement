<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAccount_Submit_Requirements.aspx.cs" Inherits="LoanManagement.Website.MyAccount_Submit_Requirements" %>
            ...
            <div id="main_column">
                ...
                <div class="section_w590">
                    ...
                    <table class="auto-style1">
                        ...
                        <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="Lime" Text="List Of Submitted Requirements"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table class="auto-style7">
                                    <tr>
                                        <td class="auto-style8">
                                                        <asp:Label ID="lblCheck" runat="server" Font-Size="Large" ForeColor="Red" Text="You currently don't have any submitted requirements" Visible="False"></asp:Label>
                                                    </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table class="auto-style10">
                                                <tr>
                                                    <td class="auto-style11">
                                                        <asp:Panel ID="pnlHidden" runat="server" Height="173px" Visible="False">
                                                            <asp:GridView ID="dg" runat="server" AutoGenerateSelectButton="True" CellPadding="4" CellSpacing="2" ForeColor="#333333" GridLines="None" Width="634px" OnSelectedIndexChanged="dg_SelectedIndexChanged">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Panel ID="Panel3" runat="server" Height="184px">
                                                            &nbsp;<asp:FileUpload ID="FileUpload1" runat="server" Width="332px" />
                                                            <br />
&nbsp;<asp:Button ID="btnUpload" runat="server" Text="Upload" Width="101px" OnClick="btnUpload_Click" />
                                                            <br />
