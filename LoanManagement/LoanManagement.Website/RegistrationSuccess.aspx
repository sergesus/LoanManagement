<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationSuccess.aspx.cs" Inherits="LoanManagement.Website.RegistrationSuccess" %>
    	...
    	<div id="templatemo_content">
            ...
            <div id="main_column">
                ...
                <div class="section_w590">
                    <h3>
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="Lime" Text="Registration Successfull"></asp:Label>
                    </h3>
