<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAccount_Main.aspx.cs" Inherits="LoanManagement.Website.MyAccount_Main" %>
                        ...
                        <tr>
                            ...
                            <td class="auto-style5">
                                <asp:Panel ID="Panel1" runat="server" Height="26px">
                                    <div id="menu">
    	                                <ul>
                                            <li><a href="MyAccount_Main.aspx" class="current">My Profile</a></li>
                                ...
                                <asp:Panel ID="Panel3" runat="server" Height="411px">
                                    ...
                                    <table class="auto-style7">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblName" runat="server" Font-Size="Medium" Text="-"></asp:Label>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblBirthday" runat="server" Font-Size="Medium" Text="-"></asp:Label>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblGender" runat="server" Font-Size="Medium" Text="-"></asp:Label>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblSSS" runat="server" Font-Size="Medium" Text="-"></asp:Label>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblTIN" runat="server" Font-Size="Medium" Text="-"></asp:Label>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
