<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirmation.aspx.cs" Inherits="LoanManagement.Website.Confirmation" %>
    	...
    	<div id="templatemo_content">
            ...
            <div id="main_column">
                ...
                <div class="section_w590">
                    <h3>
                        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="Lime" Text="Confirmation Successfull"></asp:Label>
                    </h3>
                    <p>You can now login
                        <asp:LinkButton ID="LinkButton3" runat="server" PostBackUrl="~/Login.aspx">here</asp:LinkButton>
&nbsp;to use our online features.</p>
